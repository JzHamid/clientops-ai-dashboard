    ...
    <main className="grid min-h-screen place-items-center bg-[#08090d] px-4 py-10 text-zinc-100">
      <section className="w-full max-w-md rounded-lg border border-white/10 bg-white/[0.04] p-6 shadow-2xl shadow-black/30">
        ...
        <p className="mt-2 text-sm leading-6 text-zinc-400">
          Access your client operations dashboard, projects, tasks, and notes.
        </p>
        ...
        {params.message ? (
          <div className="mt-5 rounded-lg border border-emerald-400/25 bg-emerald-400/10 p-3 text-sm text-emerald-100">
            {params.message}
          </div>
        ) : null}
        ...
        <p className="mt-5 text-center text-sm text-zinc-400">
          New here?{" "}
          <Link className="font-medium text-cyan-200 hover:text-cyan-100" href="/signup">
            Create an account
          </Link>
        </p>
      </section>
